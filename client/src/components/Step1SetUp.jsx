...
function Step1SetUp({ onStart }) {
    ...
    const handleStart = async () => {
        setLoading(true)
        try {
            const result = await axios.post(process.env.ServerUrl + "/api/interview/generate-questions", { role, experience, mode, resumeText, projects, skills }, { withCredentials: true })
            console.log(result.data)
            if (userData) {
